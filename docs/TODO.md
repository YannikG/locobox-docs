...
- [ ] **Screenshots:** Wo die Oberfläche visuell erklärt werden soll, fehlen teils noch Abbildungen. Passende Stellen bei Bedarf mit der App abgleichen und Bilder mit aussagekräftigem Alternativtext ergänzen.
- [ ] **CSV-Import:** Optional Schritt-für-Schritt-Screens des Assistenten (Datei, Zuordnung mit beiden Registern, Vorschau-Tabelle, Ausführen) für `artikel/artikel-csv-import`.
