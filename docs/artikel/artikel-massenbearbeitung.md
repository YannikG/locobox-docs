...
title: Artikel in Masse bearbeiten
...
**Wo:** Hauptmenü **Sammlung** → unter **Artikel** den Eintrag **Massenbearbeitung**.

Voraussetzung ist, dass mindestens ein Artikel ausgewählt und mindestens ein bearbeitbares Feld gewählt wird.
Die Oberfläche führt in vier Schritten durch den Vorgang: **Artikel auswählen**, **Felder auswählen**, **Werte setzen**, **Vorschau**.
...
- Ohne Premium gilt: «Nicht-Premium: Nur Felder aus Modell Details sind für Massenbearbeitung verfügbar.»
- Das Feld **Labels** ist mit Premium verfügbar und setzt oder leert die [Labels](artikel-labels.md) aller ausgewählten Artikel (Hinweis «Wählen Sie Arbeitsflow-Labels für alle ausgewählten Artikel aus.»).
...
Beim Modus **Wert löschen** gilt der Hinweistext aus der App: «Aktueller Wert wird bei allen ausgewählten Artikeln gelöscht.»
...
- Pro Artikel werden die geplanten Feldänderungen aufgelistet (Spalten **Artikel** und **Änderungen**).

Wenn alle Angaben konsistent sind, können Sie die Massenbearbeitung anwenden.

## Anwenden und Ergebnis

Mit **Massenbearbeitung anwenden** starten Sie die Übernahme. Es erscheint die Sicherheitsabfrage «Möchten Sie die Massenbearbeitung wirklich anwenden?»

Während der Verarbeitung zeigt die Anzeige, wie viele Artikel von der Gesamtanzahl bereits verarbeitet wurden.
...
- Fehlschläge bleiben in der Meldung als Anzahl enthalten; die erfolgreichen Artikel sind trotzdem geändert worden.

Schlägt die Aktion insgesamt fehl oder die Liste lässt sich nicht laden, erscheint eine Meldung mit der Überschrift **Fehler** und dem Hinweis «Ein unerwarteter Fehler ist aufgetreten. Bitte versuchen Sie es später erneut.»
...
Verlassen Sie den Ablauf mit ungespeicherten Änderungen, kann die übliche Sicherheitsabfrage zu ungespeicherten Änderungen erscheinen.

## Zusammen mit anderen Bereichen

Massenbearbeitung betrifft nur Artikeldaten. Sie ersetzt nicht die Bearbeitung einzelner Artikel in der Liste, wenn Sie Bilder, [Decoder](../decoder/decoder.md)-Verknüpfungen oder [Züge](../zuege/zuege.md) im Detail pflegen möchten. Artikelset-Zugehörigkeit und Dokumentlinks gehören nicht in diesen Ablauf.
